...
class Video:
    def __init__(self, title, duration, adult_mode=False):
        ...
        self.time_now = 0  # Текущая остановка видео
...
class UrTube:
    ...
    def watch_video(self, title):
        ...
        while video.time_now < video.duration:
            ...
            video.time_now += 1
            time.sleep(1)  # Имитируем задержку в 1 секунду
        print("Конец видео")
...
ur.register('vasya_pupkin', 'F8098FM8fjm9jmi', 55)  # Требует хэшированный пароль
